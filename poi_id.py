...
# Create new features, "fraction_to_poi", "fraction_from_poi", and 
# 'avg_fraction_to_from_poi', which represent the proportion of emails 
# each individual sends or receives to POIs, and average of two fractions.
my_dataset = data_dict
...
# Plot these new variables. 
features = ['fraction_from_poi','fraction_to_poi']
data = featureFormat(my_dataset, features)
for point in data:
    fraction_from_poi = point[0]
